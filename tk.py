...
#fenetre.iconbitmap("\home\jeanpi\Bureau\Travail_Python\ 19122020\ tatoum.ico")
fenetre.title("CALCUL   I_F_T")
...
'''
# Création de la requete  Uniquement 1 fois pour créer nom email tel ....ect
req = "CREATE TABLE fichier(id INTEGER PRIMARY KEY AUTOINCREMENT, Identité TEXT NOT NULL, Tel TEXT NOT NULL, Email TEXT NOT NULL)"
...
def sauvegarde():
    ...
    cur.execute("Insert into fichier (Identité,Tel,Email) values (?,?,?)",(contenu_nom , contenu_Tel, contenu_Email)) # Insérer les données dans la         BDD
